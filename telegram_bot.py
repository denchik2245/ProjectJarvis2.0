...
HELP_TEXT = (
    ...
    "2) Добавь встречу с Иваном завтра в 15:00\n"
    "3) Перенеси встречу с Иваном на 16:00\n\n"
    "=== Google Drive ===\n"
    "1) Покажи файлы из папки домашка\n"
    "2) Покажи всё, что лежит в папке домашка\n\n"
    "=== Google Contacts ===\n"
    "1) Дай мне номер Антона из ЧелГУ\n"
    "3) Когда день рождения у Антохи?\n"
    "4) Добавь контакт Глеб из ЧелГУ +79126973674\n"
    "5) Дай мне почту и номер телефона Антохи\n\n"
    "=== Яндекс Погода ===\n"
